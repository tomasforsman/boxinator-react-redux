        ...
        <h1>Add Box</h1>
          <form onSubmit={this.onSubmit}>
              <div>
                  ...
                  <br/>
                  <input name="name" id="name" type="text" onChange={this.onChange} value={this.state.name} /> <br/>
                  <span id="nameError" className={this.state.nameErrorClass}>You need more letters in your name.</span>
              </div>
              <br/>
              <div>
                  <label htmlFor="weight">Weight: </label>
                  <br/>
                  <input name="weight" id="weight" type="text" onChange={this.onChange} value={this.state.weight} /> <br/>
                  <span id="weightError" className={this.state.weightErrorClass}>Weight can't be a negative number.</span>
              </div>
              <br/>
              <div>
                  <label htmlFor="color">Color: (Blue shades not available)</label>
                  <br/>
                  <input name="color" id="color" type="color" onChange={this.onChange} value={this.state.color} /> <br/>
                  <span id="colorError" className={this.state.colorErrorClass}>You can't pick a color from the blue spectrum.</span>
              </div>
              <br/>
              <div>
                  <label htmlFor="country_id">Country: </label>
                  <br/>
                  <select name="country_id" id="country_id" onChange={this.onChange} value={this.state.country_id}>
              ...
              <div>
                  <br/>
                  <button type="submit" id="submit" className="btn-form">Submit</button>
              </div>
          </form>
        </div>
    )
